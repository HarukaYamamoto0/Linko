...
import com.harukadev.linko.presentation.bottom_sheet_options.TextFieldWithTitle
                ...
                Button(
                    ...
                    onClick = {
                        navController.navigate(
                            ResultRouter(
                                url = uiState.url,
                                urlShort = uiState.urlShort,
                                optionQR = uiState.optionQR,
                                optionStatistics = uiState.optionStatistics
                            )
                        )
                    },
                    shape = RoundedCornerShape(10.dp)
